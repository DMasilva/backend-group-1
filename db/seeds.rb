...
Applicant.create(username: "Shebang", first_name: "Hellen", last_name: "Akinyi", age: 24, date_of_birth: 1999-03-02, password:"12345", email: "shebang@gmail.com")
Applicant.create(username: "earth", first_name: "William ", last_name: "Kentridge", age: 23, date_of_birth: 2000, email: "willmuh@gmail.com", password:"test")
Applicant.create(username: "ice", first_name: "Geri", last_name: "wakasongsa", age: 25, date_of_birth: 1998, email: "geri500@gmail.com", password:"12345")
Applicant.create(username: "fire", first_name: "Adel", last_name: "Abdessemed", age: 22, date_of_birth: 2001, email: "armtàge500@gmail.com", password:"masilva")
Applicant.create(username: "sun", first_name: "Wangechi", last_name: "Mutu", age: 20, date_of_birth: 2003, email: "wangechimutu@gmail.com", password:"12345")
Applicant.create(username: "alex", first_name: "Julie", last_name: "Mehretu", age: 24, date_of_birth: 1999, email: "mahretujulie@yahoo.com", password:"12345")
Applicant.create(username: "trojan", first_name: "Wael", last_name: "Shawky", age: 23, date_of_birth: 2000, email: "waeelshawky@yaohoo.com", password:"ooooo")
Applicant.create(username: "troy", first_name: "Cisco", last_name: "Ramon", age: 19, date_of_birth: 2004, email: "ciscoRamon@yahoo.com", password:"12345")
Applicant.create(username: "baz", first_name: "Luke ", last_name: "Dunphy", age: 20, date_of_birth: 2003, email: "lukie@yahoo.com", password:"12345")
Applicant.create(username: "clark", first_name: "Luke ", last_name: "Dunphy", age: 24, date_of_birth: 1999, email: "lukie@yahoo.com", password:"12345")
Applicant.create(username: "cent", first_name: "Jean", last_name: "Albèrola", age: 21, date_of_birth: 2002, email: "jeanMicheal@gmail.com", password:"12345")
